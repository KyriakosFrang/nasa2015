...
VALUES(?,?,?,?,?,?,?,?,?,?,?,?)");
		...
		//Radiation thresshold
									...
									$sql = "SELECT User.Username,Current_State.Name FROM User INNER JOIN Journey_has_User ON Journey_has_User.User_idUser=User.idUser INNER JOIN Login ON Journey_has_User.Journey_idJourney=Login.Journey_has_User_Journey_idJourney AND Journey_has_User.User_idUser=Login.Journey_has_User_User_idUser AND Journey_has_User.Start_date=Login.Journey_has_User_Start_date INNER JOIN Current_State ON Current_State.idCurrent_State=Login.Current_State_idCurrent_State WHERE Login.idLogin='".$obj->login_id."';";
									$result = $conn->query($sql);
